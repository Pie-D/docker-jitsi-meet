...
var config = {
    // Connection
    //
// recordingType: 'jibri',  // Chỉ định ghi âm bằng Jibri

    // Cấu hình Jibri
  //  jibri: {
        // URL của Jibri API (địa chỉ IP và cổng của Jibri)
    //    apiUrl: 'https://meet.dev.com:5222', // Cập nhật với IP và cổng của Jibri

        // Optional: Có thể cấu hình thêm các thông số khác, như địa chỉ của Jibri
      //  recordingDirectory: '/srv/recordings', // Thư mục lưu bản ghi (trên máy chủ Jitsi hoặc Jibri)
//        finalizeRecordingScriptPath: '/path/to/finalize_recording.sh' // Đường dẫn đến script để xử lý bản ghi khi hoàn thành (nếu có)
   // },
hosts: {
        // XMPP domain.
        domain: 'meet.dev.com',
        ...
        // When using authentication, domain for guest users.
        anonymousdomain: 'guest.meet.dev.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'meet.dev.com',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.dev.com',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'meet.dev.com',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://meet.dev.com/' + subdir + 'http-bind',
    fileRecordingsEnabled: true, // If you want to enable file recording
    liveStreamingEnabled: true, // If you want to enable live streaming
    // Websocket URL (XMPP)
    // websocket: 'wss://meet.dev.com/' + subdir + 'xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.meet.dev.com',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="meet.dev.com" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://meet.dev.com/static/oauth.html'
    //     redirectURI:
    //          'https://meet.dev.com/subfolder/static/oauth.html',
    // },
    ...
    //     // ./src/react/features/transcribing/translation-languages.json.
        translationLanguages: ['vi','en'],

    //     // Important languages to show on the top of the language list.
        translationLanguagesHead: ['vi','en'],
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.meet.dev.com',
    ...
    //      'https://myservice.com/auth/{room}?code_challenge_method=S256&code_challenge={code_challenge}&state={state}'
     tokenAuthUrl: 'https://meet.dev.com/static/oidc-pre-auth.html?path={room}&room={room}&state={state}',
    ...
    // tokenLogoutUrl: 'https://myservice.com/logout'
      tokenLogoutUrl: 'https://iam.cmcati.vn/realms/CIST_1/protocol/openid-connect/logout?client_id=c-meet-online&post_logout_redirect_uri=https://meet.dev.com',
    ...
    */
    ...
    //     // https://github.com/jitsi/excalidraw-backend
         collabServerBaseUrl: 'https://meet.dev.com',
