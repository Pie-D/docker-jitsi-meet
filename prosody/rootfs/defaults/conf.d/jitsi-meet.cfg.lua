...
{{ $ENABLE_APP_SECRET := .Env.JWT_APP_SECRET | default "true" | toBool -}}
...
{{ $ENABLE_TRANSCRIPTIONS := .Env.ENABLE_TRANSCRIPTIONS | default "1" | toBool -}}
...
{{ $JWT_ALLOW_EMPTY := .Env.JWT_ALLOW_EMPTY | default "1" | toBool -}}
